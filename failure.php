        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                  <div class="jumbotron text-center">
                    <h1 class="display-3">¡Hubo un problema!</h1>
                    <p class="lead">Vuelve al inicio e <strong>intenta nuevamente</strong></p>
                    <hr>
                    <p class="lead">
                      <a class="btn btn-primary btn-sm" href="<?=BASE_URL?>" role="button">Volver al inicio</a>
                    </p>
                  </div>
            </div>
        </div>
