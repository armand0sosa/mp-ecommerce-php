        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                  <div class="jumbotron text-center">
                    <h1 class="display-3">¡Ya casi!</h1>
                    <p class="lead"><strong>Revisa tu correo</strong>, tienes un pago pendiente por realizar.</p>
                    <hr>
                    <p class="lead">
                      <a class="btn btn-primary btn-sm" href="<?=BASE_URL?>" role="button">Continuar en nuestro sitio</a>
                    </p>
                  </div>
            </div>
        </div>
